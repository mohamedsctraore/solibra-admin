...
<div class="row">
    <div class="col-md-4">
        <div>
            <a href="{{route ('categories.create')}}" type="button" class="btn btn-success waves-effect waves-light mb-3"><i class="mdi mdi-plus me-1"></i> Ajouter Categorie</a>
        </div>
            ...
            <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="javascript: void(0);" class="text-dark fw-bold">{{ $categorie->id }}</a> </td>
                        <td>
                        {{ $categorie->nom }}
                        </td>

                        <td>
                            <a href="{{ route('categories.edit', $categorie->id) }}" class="px-3 text-primary"><i class="uil uil-pen font-size-18"></i></a>
                                <a onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet categorie ?')"  type="submit" class="px-3 text-danger"><i class="uil uil-trash-alt font-size-18"></i></a >
                        </td>
                    </tr>
                    @endforeach
                </tbody>
